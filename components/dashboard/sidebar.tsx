    ...
    <>
      ...
      <div className="lg:hidden fixed top-4 left-4 z-50">
        <button
          ...
          className="p-2.5 rounded-xl bg-slate-900 border border-slate-800 text-white shadow-xl shadow-black/40 focus:outline-none"
      ...
      <aside
        className={`fixed top-0 bottom-0 left-0 z-40 w-72 bg-slate-900/95 border-r border-slate-800/80 flex flex-col transition-transform duration-200 ease-in-out lg:translate-x-0 ${
          isOpenMobile ? "translate-x-0" : "-translate-x-full"
        }`}
      >
        {/* Brand Header */}
        <div className="p-5 border-b border-slate-800/80 flex items-center gap-3.5">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-indigo-600 to-blue-500 shadow-md shadow-indigo-600/30 flex items-center justify-center font-black text-white text-sm tracking-wider border border-indigo-400/20">
            PA
          </div>
          <div>
                  ...
                  return (
                    <li key={item.name}>
                      ...
                      >
                        ...
                        {item.badge && (
                          <span className="text-[9px] px-2 py-0.5 rounded-full bg-slate-800 border border-slate-700 text-indigo-300 font-bold">
                            {item.badge}
                          </span>
                        )}
                      </Link>
        ...
        <div className="p-4 border-t border-slate-800/80 bg-slate-950/60">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-xl text-xs font-bold text-rose-300 bg-rose-950/40 hover:bg-rose-900/50 border border-rose-800/30 transition-all cursor-pointer"
          >
