    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="p-16 text-center card-floating">
          ...
          <p className="text-base font-bold text-[#313647] mb-1">Katalog jasa masih kosong</p>
        ...
        <div className="overflow-x-auto card-floating">
          <table className="w-full text-left text-xs text-[#313647]">
            ...
            <tbody className="divide-y divide-[#435663]/10">
              {services.map((srv) => (
                <tr key={srv.id} className="hover:bg-[#FFF8D4]/40 transition-colors group">
                  <td className="py-4 px-5 font-mono font-bold text-xs">
                    <span className="px-2.5 py-1 rounded-lg bg-[#313647] text-[#FFF8D4]">
                      {srv.code}
                    </span>
                  </td>
                  <td className="py-4 px-5">
                    <p className="font-bold text-[#313647] text-sm">{srv.name}</p>
                    {srv.description && (
                      <p className="text-[11px] text-[#435663] mt-1 line-clamp-1 max-w-md">
                        {srv.description}
                      </p>
                    )}
                  </td>
